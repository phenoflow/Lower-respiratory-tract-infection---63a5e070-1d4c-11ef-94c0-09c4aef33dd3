...
(async () => {
  ...
  await fs.writeFile("lower-respiratory-tract-infection-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("lower-respiratory-tract-infection-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
